...
static run_result run_print_version(base_action &act)
{
...
std::shared_ptr<base_action> act_print_version(application &app)
{
	return std::make_shared<action>("print version",
					"easyopts",
